...
class FormStep2
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="universityDegree", type="boolean", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="lastQualificationS2", type="string", length=255)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="graduationYearS2", type="string", length=255)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="schoolNameS2", type="string", length=255)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="countryS2", type="string", length=255)
     */
    private $countryS2;
