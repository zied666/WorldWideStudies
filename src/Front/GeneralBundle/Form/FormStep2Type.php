    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
                ->add('universityDegree', 'choice', array(
                    'choices' =>array( "Yes"=>'Yes', "No"=>'No', "Pending"=>"Pending" ),
                    'required'=>TRUE,
                    'expanded'=>TRUE,
                ))
                ...
                ->add('englishTest', 'choice', array(
                    'choices' =>array( TRUE=>'Yes', FALSE=>'Pending' ),
                    'required'=>TRUE,
                    'expanded'=>TRUE,
                ))
